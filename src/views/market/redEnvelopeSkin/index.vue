<template>
  <div>
    ...
    >
      <div class="addbtn" @click="clickAdd">添加红包皮肤</div>
    </div>
    ...
    <div class="app-container" style="margin-right: 30px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="皮肤图" width="150" align="center">
          <template slot-scope="{ row }">
            <img style="width: 80px; height: 100px" :src="row.goodsPicture" />
          </template>
        </el-table-column>
        <el-table-column label="开红包上图" width="150" align="center">
          <template slot-scope="{ row }">
            <img style="width: 90px; height: 90px" :src="row.extend1" />
          </template>
        </el-table-column>
        <el-table-column label="开红包下图" width="150" align="center">
          <template slot-scope="{ row }">
            <img style="width: 100px; height: 50px" :src="row.extend2" />
          </template>
        </el-table-column>
        <el-table-column
          prop="goodsScore"
    ...
    <el-dialog title="红包皮肤" :visible.sync="dialogVisible" top="2vh" :close-on-click-modal="false">
      <el-form
        label-width="120px"
        :model="formData"
        :rules="rules"
        ref="formData"
      >
        <el-form-item label="红包皮肤：" prop="goodsName">
          <el-input
        ...
        <el-row :gutter="21">
          <el-col :span="10">
            <el-form-item label="K集展示图：" prop="backgroundImage">
          ...
          <el-col :span="10">
            <el-form-item label="红包皮肤：" prop="goodsPicture">
        ...
        <el-row :gutter="21">
          <el-col :span="10">
            <el-form-item label="开红包上图：" prop="extend1">
          ...
          <el-col :span="10">
            <el-form-item label="开红包下图：" prop="extend2">
              <div class="img_con2" v-for="(i, index) in imgList4" :key="index">
                <el-image
                  class="deduct_img2"
                  :src="i"
                  :preview-src-list="[i]"
...
export default {
  data() {
    return {
      uploadModule: "market/redEnvelopeSkin",
      imgList1: [],
      imgList2: [],
      imgList3: [],
      imgList4: [],
      ...
      rules: {
        ...
        goodsPicture: [
          { required: true, message: "请上传红包皮肤", trigger: "change" },
        ],
        backgroundImage: [
          { required: true, message: "请上传K集展示图", trigger: "change" },
        ],
        extend1: [
          { required: true, message: "请上传开红包上段图", trigger: "change" },
        ],
        extend2: [
          { required: true, message: "请上传开红包下段图", trigger: "change" },
        ],
      },
      pickerOptions: {
        disabledDate(time) {
  ...
  methods: {
    ...
    clickUpdate(row) {
      ...
      this.imgList3[0] = row.extend1;
      this.imgList4[0] = row.extend2;
    },
    clickPublish(row) {
    ...
    handleRemove3(index) {
      ...
      this.formData.extend1 = null;
    },
    getUrl4(e) {
      this.imgList4.push(e);
      this.formData.extend2 = e;
      this.$message({
        type: "success",
        message: "上传成功",
      });
