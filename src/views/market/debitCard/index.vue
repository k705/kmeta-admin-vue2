<template>
  <div>
    ...
    >
      <div class="addbtn" @click="clickAdd">添加结算卡</div>
    </div>
    ...
    <div class="app-container" style="margin-right: 30px">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column
          ...
          align="center"
        />
        <el-table-column label="结算卡图" width="150" align="center">
    ...
    <el-dialog title="结算卡" :visible.sync="dialogVisible" top="2vh" :close-on-click-modal="false">
      <el-form
        label-width="120px"
        :model="formData"
        :rules="rules"
        ref="formData"
      >
        <el-form-item label="结算卡：" prop="goodsName">
          <el-input
        ...
        <el-form-item label="跳转链接：">
          <el-input v-model="formData.jumpLink" style="width: 350px"></el-input>
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        goodsName: [
          { required: true, message: "请输入结算卡名称", trigger: "change" },
        ],
        exchangeTime: [
        ...
        goodsPicture: [
          { required: true, message: "请上传结算卡产品图", trigger: "change" },
        ],
        backgroundImage: [
  ...
  methods: {
    ...
    validateExchangeTime(rule, value, callback) {
      ...
      if (value && value.length >= 2) {
        ...
        callback(new Error("请选择结算卡有效时间")); // 长度不符合要求，验证失败
      }
    },
    handleDateChange() {
