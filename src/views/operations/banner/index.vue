<template>
  <div>
      ...
      <div class="content-container">
        <el-carousel :interval="2500" type="card" height="900px" style="margin-left: 20px; width: 50%; flex: 1;" :autoplay="!bannerForm.id">
...
export default {
  ...
  methods: {
    ...
    bannerDelist() {
      reqBannerDelist({id: this.bannerForm.id}).then(() => {
        this.$message({
          type: "success",
          message: "撤销成功",
        });
